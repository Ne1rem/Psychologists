...
const FavouritesCard = ({
  ...
  const [isModalAppointmentFavOpen, setIsModalAppointmenFavtOpen] =
    useState(false);
  ...
  const closeModalAppointment = () => {
    setIsModalAppointmenFavtOpen(
      isModalAppointmentFavOpen => !isModalAppointmentFavOpen
    );
  };
      ...
      {filteredPsychologists
        ...
        .map(favoritePsychologist => (
          ...
          >
            ...
            <AvatarWrap
              src={favoritePsychologist.avatar_url}
            ...
            <DescriptionWrap>
              <HeadDescriptionWrap>
                ...
                <RatingPriceBlock>
                  ...
                  <RatingPriceText>
                    Rating: {favoritePsychologist.rating}
                  </RatingPriceText>
                  <RatingPriceText>
                    Price / 1 hour:{' '}
                    <RatingPriceTextSpan>
                  ...
                  onClick={() =>
                    isLoggedIn
                      ? favoritePsychologists.some(
                          favorite =>
                            favorite.name === favoritePsychologist.name
                        )
              ...
              <SkillsBlock>
                <SkillsBlockText>
                  ...
                  {favoritePsychologist.experience} years
                </SkillsBlockText>
                <SkillsBlockText>
                  <SkillsSpan>License: </SkillsSpan>{' '}
                  {favoritePsychologist.license}
                </SkillsBlockText>
                <SkillsBlockText>
